...
Если недостаточно &НаборОборудования[Оборудование,Оборудование.ИнвентарныйНомер,ИнвентарныйНомер]%1 Тогда заполнение реализуеться через отдельную
функцию где больше возможностей (задать свои имена колонок, добавить что-то свое и т.д.)
